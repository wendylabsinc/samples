...
Uses GStreamer WebRTC when HW encoding is available, otherwise falls back
to MJPEG-over-WebSocket which requires no encoding (camera outputs MJPEG natively).
"""
import asyncio
import collections
import glob
